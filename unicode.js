...
let firstLaunchPoint = inputString2.charCodeAt(0);
let lastLaunchPoint = inputString2.charCodeAt(inputString2.length-1)
let swappedString = String.fromCharCode(lastLaunchPoint) + inputString2.slice(1,inputString2.length-1) + String.fromCharCode(firstLaunchPoint); // Your code here
